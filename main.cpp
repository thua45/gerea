//
// Created by Tinghua Huang on 19/12/8.
//
...
int main(int argc, char *argv[]) {
    ...
    double q_threshold, fc_threshold;
    int target_n;
    string class_str;
    q_threshold = 0.05;
    fc_threshold = 1.5;
    ...
    gerea_it.reading_data_exp(exp_file);
    //cout<<"OK2"<<endl;

    gerea_it.data_permutation();

    gerea_it.loading_data2network();
    //cout<<"OK3"<<endl;

    gerea_it.run_stat_dt2_dbt3();
    //cout<<"OK4"<<endl;


    //here
    gerea_it.Print_result6(output_dir);
    //cout<<"OK5"<<endl;

    gerea_it.Print_details5(output_dir);
